...
namespace SimpleEasing
{
	...
	public class Tween {
		...
		/// <param name="repeat">Repeat.</param>
		/// <param name="OnComplete">On complete.</param>
		public Tween(Action<Quaternion> valueSetter, Quaternion from, Quaternion to, float length, EasingTypes easeType = EasingTypes.Linear,bool unscaled = false, TweenRepeat repeat = TweenRepeat.Once, Action OnComplete= doNothing)
		{
