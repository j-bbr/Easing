...
namespace SimpleEasing
{
	public static class ExtensionMethods{
		                          ...
		                          Action onComplete = null)
		{
			...
			return SimpleEasing.ExtensionMethods.MoveTo(trans, start, target, length, 
		                               ...
		                               Action onComplete = null)
		{
			...
			return SimpleEasing.ExtensionMethods.LocalMoveTo(trans, start, target, length, 
				easingChoice, unscaled, repeat, onComplete);
		}
		/// <summary>
		...
		public static Coroutine ScaleTo(this Transform trans, Vector3 start, Vector3 target, float length, EasingTypes easingChoice, bool unscaled = false, 
		                          ...
		                          Action onComplete = null)
		{
			return TweenManager.instance.PlayTween(new Tween((Vector3 scale)=>{
		...
		public static Coroutine RotateTo(this Transform trans, Vector3 start, Vector3 target, float length, EasingTypes easingChoice, bool unscaled = false, 
			...
			Action onComplete = null)
		{
			return SimpleEasing.ExtensionMethods.RotateTo(trans, Quaternion.Euler(start), Quaternion.Euler(target), length,
				easingChoice, unscaled, repeat, onComplete);
		}
		public static Coroutine RotateTo(this Transform trans, Vector3 target, float length, EasingTypes easingChoice, bool unscaled = false, 
			...
			Action onComplete = null)
		{
			return SimpleEasing.ExtensionMethods.RotateTo(trans, Quaternion.Euler(target), length,
				easingChoice, unscaled, repeat, onComplete);
		}
		...
		public static Coroutine RotateTo(this Transform trans, Quaternion start, Quaternion target, float length, EasingTypes easingChoice, bool unscaled = false, 
			...
			Action onComplete = null)
		{
			return TweenManager.instance.PlayTween(new Tween((Quaternion rot)=>{
			...
			Action onComplete = null)
		{
			...
			return TweenManager.instance.PlayTween(new Tween((Vector2 newPivot)=>{
				rect.pivot = newPivot;
			}, start, target, length, easingChoice, unscaled, repeat, onComplete));
		}
			...
			Action onComplete = null)
		{
			...
			return TweenManager.instance.PlayTween(new Tween((Vector2 newMax)=>{
			...
			Action onComplete = null)
		{
			...
			return TweenManager.instance.PlayTween(new Tween((Vector2 newMin)=>{
			...
			Action onComplete = null)
		{
			...
			return TweenManager.instance.PlayTween(new Tween((Vector2 newDelta)=>{
			...
			Action onComplete = null)
		{
			...
			return TweenManager.instance.PlayTween(new Tween((Color newColor)=>{
